...
public class ReviewController {
     ...
     public ResponseEntity<ReviewResponse> createReview(@PathVariable("carId") String carId,
     ...
     public ResponseEntity<Page<ReviewResponse>> listReviews(@PathVariable("carId") String carId,
